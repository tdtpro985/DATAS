...
ALTER TABLE `platform_tracking`
  ...
  ADD KEY `idx_platform_tracking` (`platform_id`),
...
--
ALTER TABLE `platform_tracking`
  ADD CONSTRAINT `fk_platform_tracking_platform` FOREIGN KEY (`platform_id`) REFERENCES `platform_leads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_platform_tracking_sales_rep` FOREIGN KEY (`sales_rep_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
