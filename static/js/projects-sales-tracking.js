    ...
    return new Promise((resolve) => {
        ...
        confirmModal.innerHTML = `
            ...
            <div style="display: flex; gap: 1rem; justify-content: flex-end; padding: 1.5rem; border-top: 1px solid rgba(0,0,0,0.08);">
                <button class="clear-confirm-cancel" style="padding: 0.75rem 1.5rem; background: rgba(107, 114, 128, 0.2); border: 1px solid rgba(107, 114, 128, 0.4); border-radius: 0.75rem; color: #000000; font-size: 0.9rem; font-weight: 600; cursor: pointer;">
                    Cancel
                </button>
