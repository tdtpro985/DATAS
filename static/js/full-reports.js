...
const FullReports = {
        ...
        document.getElementById('contractorAnalytics').innerHTML = `
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;padding:1rem;background:var(--bg-card);border-top:1px solid var(--border-color);">
                ...
                <div style="display:flex;gap:0.5rem;">
                    ...
                    <button onclick="FullReports.changeContractorPage(${this.contractorPagination.currentPage+1})" ${this.contractorPagination.currentPage>=totalPages?'disabled':''} style="padding:0.4rem 0.8rem;background:var(--primary);color: #000000;border:none;border-radius:4px;cursor:pointer;font-size:0.85rem;${this.contractorPagination.currentPage>=totalPages?'opacity:0.5;cursor:not-allowed;':''}">Next</button>
                </div>
            </div></div>`;
    },
    ...
    renderProjectsByRegionChart(byRegion) {
        ...
        this.charts.projectsByRegion = new Chart(ctx, {
            ...
            options:{ responsive:true, maintainAspectRatio:true, aspectRatio:2, plugins:{ legend:{display:false}, tooltip:{backgroundColor: '#FFFFFF',titleColor:'#f97316',bodyColor: '#000000',borderColor:'#f97316',borderWidth:1} }, scales:{ y:{ beginAtZero:true, ticks:{color:'#1F2937'}, grid:{color:'rgba(0,0,0,0.04)'} }, x:{ ticks:{color:'#1F2937',maxRotation:45}, grid:{display:false} } } }
        });
    },
    ...
    renderProjectsByStatusChart(byStatus) {
        ...
        this.charts.projectsByStatus = new Chart(ctx, {
            ...
            options:{ responsive:true, maintainAspectRatio:true, aspectRatio:1.5, plugins:{ legend:{position:'right',labels:{color:'#1F2937',font:{size:11}}}, tooltip:{backgroundColor: '#FFFFFF',titleColor:'#f97316',bodyColor: '#000000',borderColor:'#f97316',borderWidth:1} } }
        });
    },
    ...
    renderProjectsBySourceChart(bySource) {
        ...
        this.charts.projectsBySource = new Chart(ctx, {
            ...
            options:{ responsive:true, maintainAspectRatio:true, aspectRatio:1.5, indexAxis:'y', plugins:{ legend:{display:false}, tooltip:{backgroundColor: '#FFFFFF',titleColor:'#f97316',bodyColor: '#000000',borderColor:'#f97316',borderWidth:1} }, scales:{ x:{ beginAtZero:true, ticks:{color:'#1F2937'}, grid:{color:'rgba(0,0,0,0.04)'} }, y:{ ticks:{color:'#1F2937'}, grid:{display:false} } } }
        });
    },
    ...
    renderSalesFunnelChart(trackingCounts) {
        ...
        this.charts.salesFunnel = new Chart(ctx, {
            ...
            options:{ responsive:true, maintainAspectRatio:true, aspectRatio:2.5, indexAxis:'y', plugins:{ legend:{display:false}, tooltip:{backgroundColor: '#FFFFFF',titleColor:'#f97316',bodyColor: '#000000',borderColor:'#f97316',borderWidth:1} }, scales:{ x:{ beginAtZero:true, ticks:{color:'#1F2937'}, grid:{color:'rgba(0,0,0,0.04)'} }, y:{ ticks:{color:'#1F2937',font:{size:13}}, grid:{display:false} } } }
        });
    },
    ...
    renderMaterialBreakdownChart(materialData) {
        ...
        this.charts.materialBreakdown = new Chart(ctx, {
            ...
            options:{ responsive:true, maintainAspectRatio:true, aspectRatio:2, plugins:{ legend:{display:false}, tooltip:{backgroundColor: '#FFFFFF',titleColor:'#f97316',bodyColor: '#000000',borderColor:'#f97316',borderWidth:1} }, scales:{ y:{ beginAtZero:true, ticks:{color:'#1F2937'}, grid:{color:'rgba(0,0,0,0.04)'} }, x:{ ticks:{color:'#1F2937'}, grid:{display:false} } } }
        });
    },
    ...
    renderMonthlyTrendsChart(byMonth) {
        ...
        this.charts.monthlyTrends = new Chart(ctx, {
            ...
            options:{ responsive:true, maintainAspectRatio:true, aspectRatio:2.5, plugins:{ legend:{display:true,labels:{color:'#1F2937'}}, tooltip:{backgroundColor: '#FFFFFF',titleColor:'#f97316',bodyColor: '#000000',borderColor:'#f97316',borderWidth:1} }, scales:{ y:{ beginAtZero:true, ticks:{color:'#1F2937'}, grid:{color:'rgba(0,0,0,0.04)'} }, x:{ ticks:{color:'#1F2937'}, grid:{display:false} } } }
        });
    },
